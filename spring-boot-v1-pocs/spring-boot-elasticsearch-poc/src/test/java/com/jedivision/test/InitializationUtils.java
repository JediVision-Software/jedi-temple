...
import static com.jedivision.test.InitializationUtils.JediClassUtils.getRandomValueByClass;
import static com.jedivision.test.InitializationUtils.JediSetterUtils.processSetters;
...
public class InitializationUtils {
    ...
    private static <T> T createNoDefaultConstructor(Class<? extends T> type) throws ReflectiveOperationException {
        ...
        Object[] args = Stream.of(constructor.getParameterTypes())
                .map(JediClassUtils::getRandomValueByClass)
                .toArray();
    ...
    // Protected Classes
    // ------------------------------------------------------------------------------------------------------
    static final class JediSetterUtils {

        private JediSetterUtils() {}
    ...
    static final class JediClassUtils {

        private JediClassUtils() {}
